...
exports.getNGram = void 0;
var needle = require("needle");
var baseUrl = 'https://books.google.com/ngrams/json';
function getNGram(ngram, options) {
...
exports.getNGram = getNGram;
function constructURL(ngram, options) {
    var url = "https://books.google.com/ngrams/json?content=" + ngram + "&year_start=" + options.year_start + "&year_end=" + options.year_end + "&corpus=" + options.corpus + "&smoothing=" + options.smoothing + (options.case_insensitive ? "&case_insensitive=true" : null);
    return url;
}
